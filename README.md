...
#### Таблица с заданиями
`tasks(id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, upload_user_id BIGINT UNSIGNED NOT NULL, dog_id BIGINT UNSIGNED NOT NULL, goal VARCHAR(255), done BOOLEAN)`

#### Таблица с решениями
`responses(id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, do_user_id BIGINT UNSIGNED NOT NULL, task_id BIGINT UNSIGNED NOT NULL, comment VARCHAR(255), photo VARCHAR(255))`
