...
#### Таблица с заданиями
`tasks(id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, upload_user_id id BIGINT UNSIGNED NOT NULL, dog_id BIGINT UNSIGNED NOT NULL, goal VARCHAR(255), done BOOLEAN)`
